  ...
  return (
    <div className="">
      <div className="max-w-[1240px] bg-white h-full w-full mx-auto mt-10  p-5 rounded-lg relative">
        ...
        <div
          className="logout  h-10 rounded-lg bg-red-600 flex justify-center items-center text-white absolute right-0 top-0 cursor-pointer p-3 mt-3"
        ...
        <div className="w-full flex flex-wrap gap-x-5 gap-y-3 items-center justify-between">
          <div className="border relative text-left p-4 max-w-[500px] w-full">
            ...
            <p className="absolute w-7 h-7 justify-center right-2 flex items-center top-2 rounded-full bg-slate-600 text-white text-center">
              {topics?.length}
            </p>
            <button
